...
interface AgentIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}
...
export const ClaudeIcon = ({ size = 24, ...props }: AgentIconProps) => (
...
export const GeminiIcon = ({ size = 24, ...props }: AgentIconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const CodexIcon = ({ size = 24, ...props }: AgentIconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const GitLogoIcon = ({ size = 24 }: BrandIconProps) => (
  <Image src="/icons/git.svg" alt="" aria-hidden width={size} height={size} />
);

export const DockerLogoIcon = ({ size = 24 }: BrandIconProps) => (
  <Image src="/icons/docker.svg" alt="" aria-hidden width={size} height={size} />
);
