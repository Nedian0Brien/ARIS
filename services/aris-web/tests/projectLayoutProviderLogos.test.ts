...
describe('project layout and provider logo guards', () => {
  ...
  it('uses the real provider logo assets in the model picker', () => {
    ...
    expect(projectChatSurface).toContain("import { ProviderLogo } from '@/components/ui/ProviderLogo';");
    expect(projectChatSurfaceUtils).toContain("import type { ProviderLogoProvider } from '@/components/ui/ProviderLogo';");
    ...
    expect(homeClient).not.toContain("import { ProviderLogo");
