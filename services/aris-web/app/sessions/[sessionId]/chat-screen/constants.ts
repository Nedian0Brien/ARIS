...
export const CUSTOMIZATION_OVERLAY_MAX_WIDTH_PX = 1280;
export const CHAT_SIDEBAR_FIXED_WIDTH_PX = 280;
export const CUSTOMIZATION_SIDEBAR_FIXED_WIDTH_PX = 320;
export const CENTER_PANEL_MIN_WIDTH_PX = 720;
export const RIGHT_PIN_PREFERS_LEFT_OVERLAY_MIN_WIDTH_PX =
