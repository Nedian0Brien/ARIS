...
import { updateProjectApprovalPolicy } from '@/lib/happy/client';
import type { ApprovalPolicy } from '@/lib/happy/types';

/**
 * PATCH /api/runtime/projects/[projectId]
...
export async function PATCH(
  ...
  try {
    ...
    const project = await updateProjectApprovalPolicy(projectId, approvalPolicy as ApprovalPolicy);
