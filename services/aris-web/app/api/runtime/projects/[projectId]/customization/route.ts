...
async function resolveProjectProjectPath(userId: string, projectId: string): Promise<string> {
...
export async function GET(
  ...
  try {
    ...
    const projectPath = await resolveProjectProjectPath(auth.user.id, projectId);
